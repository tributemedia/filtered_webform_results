...
A menu item will be created under "Reports" that links to a page with a list of links to the report page for each existing webform. Any forms added after installing the module, will have to be added manually.
